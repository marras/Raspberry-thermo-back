...
module Web
  class Application < Hanami::Application
    configure do
      ...
      #
      sessions :cookie, secret: ENV['SECRET_TOKEN']
      ...
      #
      security.content_security_policy "default-src 'none'; script-src 'unsafe-inline' 'self' https://unpkg.com; connect-src 'self'; img-src 'self'; style-src 'unsafe-inline' 'self' https://fonts.googleapis.com https://unpkg.com; font-src 'self' https://fonts.gstatic.com;"
      ...
      controller.prepare do
        ...
        def validate_signature!
          halt 400 unless params[:signature] && params[:values]
