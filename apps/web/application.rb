...
module Web
  class Application < Hanami::Application
    configure do
      ...
      #
      security.content_security_policy "default-src 'none'; script-src 'unsafe-inline' 'self'; connect-src 'self'; img-src 'self'; style-src 'unsafe-inline' 'self'; font-src 'self';"
